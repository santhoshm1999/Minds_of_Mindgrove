...
module mkUnpipelined_float(CLK,
  ...
  // action method get_start
  input  get_start_start;
  input  EN_get_start;
  output RDY_get_start;
  ...
  // register got_rg_start
  reg got_rg_start;
  wire got_rg_start_D_IN, got_rg_start_EN;
  ...
  // action method get_start
  assign RDY_get_start = !got_rg_start ;
  assign CAN_FIRE_get_start = !got_rg_start ;
  assign WILL_FIRE_get_start = EN_get_start ;

  // action method get_input_a
  assign RDY_get_input_a = rg_start && !got_rg_a ;
  assign CAN_FIRE_get_input_a = rg_start && !got_rg_a ;
  assign WILL_FIRE_get_input_a = EN_get_input_a ;

  // action method get_input_b
  assign RDY_get_input_b = rg_start && !got_rg_b ;
  assign CAN_FIRE_get_input_b = rg_start && !got_rg_b ;
  ...
  // action method get_input_c
  assign RDY_get_input_c = rg_start && !got_rg_c ;
  assign CAN_FIRE_get_input_c = rg_start && !got_rg_c ;
  assign WILL_FIRE_get_input_c = EN_get_input_c ;

  // value method get_MAC_result
  assign get_MAC_result = rg_mac_result ;
  assign RDY_get_MAC_result = add_done ;

  // value method get_stop
  assign get_stop = rg_start ;
  assign RDY_get_stop = 1'd1 ;
  ...
  assign CAN_FIRE_RL_get_mul_result =
	     mul_RDY_get_result && mul_started && !mul_done ;
  ...
  assign CAN_FIRE_RL_rl_put_add_val =
	     add_RDY_get_inp_s && add_RDY_get_inp_c && got_rg_s && got_rg_c &&
	     mul_done &&
	     !add_started ;
  ...
  assign CAN_FIRE_RL_rl_get_add_result =
	     add_RDY_get_result && add_started && !add_done ;
  ...
  assign WILL_FIRE_RL_rl_deassert_signals = add_done ;

  // register add_done
  assign add_done_D_IN = !add_done ;
  assign add_done_EN = add_done || WILL_FIRE_RL_rl_get_add_result ;

  // register add_started
  assign add_started_D_IN = !WILL_FIRE_RL_rl_get_add_result ;
  assign add_started_EN =
	     WILL_FIRE_RL_rl_get_add_result || WILL_FIRE_RL_rl_put_add_val ;

  // register got_rg_a
  assign got_rg_a_D_IN = 1'd1 ;
  assign got_rg_a_EN = EN_get_input_a ;

  // register got_rg_b
  assign got_rg_b_D_IN = 1'd1 ;
  assign got_rg_b_EN = EN_get_input_b ;

  // register got_rg_c
  assign got_rg_c_D_IN = 1'd1 ;
  assign got_rg_c_EN = EN_get_input_c ;

  // register got_rg_s
  assign got_rg_s_D_IN = 1'd1 ;
  assign got_rg_s_EN = CAN_FIRE_RL_get_mul_result ;

  // register got_rg_start
  assign got_rg_start_D_IN = 1'd1 ;
  assign got_rg_start_EN = EN_get_start ;

  // register mul_done
  assign mul_done_D_IN = !WILL_FIRE_RL_rl_put_add_val ;
  assign mul_done_EN =
	     WILL_FIRE_RL_rl_put_add_val || WILL_FIRE_RL_get_mul_result ;

  // register mul_started
  assign mul_started_D_IN = !add_done ;
  assign mul_started_EN = add_done || WILL_FIRE_RL_rl_put_mul_val ;
  ...
  // register rg_start
  assign rg_start_D_IN = !add_done && get_start_start ;
  assign rg_start_EN = EN_get_start || add_done ;
  ...
  begin
	...
	got_rg_start <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (got_rg_start_EN)
	  got_rg_start <= `BSV_ASSIGNMENT_DELAY got_rg_start_D_IN;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_put_mul_val)
	$display(v__h626, " A: %b  B: %b", rg_a, rg_b);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_put_add_val)
	$display(v__h831, " C: %b S: %b", rg_c, rg_s);
  end
  // synopsys translate_on
